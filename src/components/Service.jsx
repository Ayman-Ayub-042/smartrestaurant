...
const Service = () => {
  ...
  return (
    ...
    <div className='flex xl:flex-row md:flex-col mt-10 ml-12 sm:flex-col'>
    <div className='flex flec-row'>
        <div className='xl:w-8 lg:w-4 xl:h-20 lg:h-14 bg-orange-600 md:w-4'></div>
    ...
    <div className='flex xl:flex-row lg:flex-col md:flex-col sm:flex-col m-11 mt-24 bg-slate-200'>
    <div className='flex flex-col xl:w-3/5'>
      <div className='flex flex-row '>
        <div className='w-[40%] m-10 h-[300px] px-20 py-10 bg-orange-100 items-center justify-center '>
        {/* <md.MdDining className='text-orange-500 text-4xl'/> */}
          <img className='w-56  xl:pt-5 lg:pt-5 md:pt-10' src={img1} alt="" />
        </div>
         <div className='w-[60%] flex flex-row -ml-24 align-middle items-center'>
        
        <img src={img4} className="w-44 h-16 "/>
       <div>
...
<ServicesItems  flag={false}
    ...
    <div className='w-full  flex flex-row gap-16 bg-orange-100'>
<div className='w-2/3 justify-center  flex flex-col  pl-20 '>
<div className='xl:w-2/3 md:w-full  flex mt-10 ml-12 justify-center '>
        <div className='w-4 h-30 bg-orange-600'></div>
  ...
  <div className='w-2/3 mt-8 ml-24 items-center justify-center'>
