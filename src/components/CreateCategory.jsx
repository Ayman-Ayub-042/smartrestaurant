...
const CreateCategory = () => {
 ...
 localStorage.setItem("foodfreshCategory", JSON.stringify(datafreshcategory));
      dispatch({
        type: actionType.SET_FOOD_FRUIT_CATEGORIES,
        foodfreshCategory: datafreshcategory,
  ...
  return (
    <div className="w-full min-h-screen flex items-center justify-center">
      <div className="w-[90%] md:w-[50%] border border-gray-300 rounded-lg p-4 flex flex-col items-center justify-center gap-4">
        ...
        {/* <div className="w-full py-2 border-b border-gray-300 flex items-center gap-2">
          <MdFastfood className="text-xl text-gray-700" />
          <h3>Add to fresh fruit section </h3>
          <div >
          <label>
          <input
            type="radio"
            required
            value="yes"
            // onChange={(e) => setfreshfruit(e.target.value)}
            name="yes"
            className="w-full h-full text-lg bg-transparent outline-none border-none p text-textColor"
          />
          Yes
          </label>
          <label>
